...
function ProjectsPage() {
    const projectPictures = [Projetf1pic, MyPicture, MyPicture]
            ...
            <section className="flex lg:flex-col h-3/4 w-3/4 border-4 bg-neon-yellow/10 border-neon-yellow relative ">
                ...
                <div className="flex items-center h-full">
                    <div className="lg:flex px-5 justify-center items-center hidden w-1/2">
                        <a href="https://formula-1-database.vercel.app/" target="_blank" rel="noopener noreferrer"><img className="rounded" src={projectPictures[selectedTab]} alt="Amine"></img></a>
                    </div>
