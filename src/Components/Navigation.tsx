        ...
        <div className="flex items-center justify-center h-3/4 w-screen lg:h-screen lg:w-1/2">
            <div className="w-10/12 relative">
                ...
                <div onMouseLeave={() => setBuilding1Hovered(false)} onMouseEnter={() => setBuilding1Hovered(true)} className="group">
                    <Building1 height="70.72%" width="13.01%" preserveAspectRatio="none" className="hover:cursor-pointer absolute left-[16.31%] bottom-[15.45%]" />
                ...
                <div onMouseLeave={() => setBuilding2Hovered(false)} onMouseEnter={() => setBuilding2Hovered(true)} className="group">
                    <Building2 height="53.27%" width="21.91%" preserveAspectRatio="none" className="hover:cursor-pointer absolute left-[29.3%] bottom-[15.45%]" />
                ...
                <div onMouseLeave={() => setBuilding3Hovered(false)} onMouseEnter={() => setBuilding3Hovered(true)} className="group">
                    <Building3 height="47.45%" width="16.16%" preserveAspectRatio="none" className="hover:cursor-pointer absolute left-[51.15%] bottom-[15.45%]" /> 
                ...
                <div onMouseLeave={() => setBuilding4Hovered(false)} onMouseEnter={() => setBuilding4Hovered(true)} className="group">             
                    <Building4 height="62%" width="16.16%" preserveAspectRatio="none" className="hover:cursor-pointer absolute left-[67.15%] bottom-[15.45%]" />
